...
console.groupCollapsed("WHILE");
{
  console.groupCollapsed(
    '1. Sukurkite ciklą kuris 5 kartus atspausdintų "Sveikas Pasauli"'
  );
  {
    let i = 0;
    while (i < 5) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "2. Sukurkite ciklą kuris atspausdintų nuo 1 iki 5. Naudojant <"
  );
  {
    let i = 1;
    while (i < 6) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "3. Sukurkite ciklą kuris atspausdintų nuo 3 iki 7. Naudojant <"
  );
  {
    let i = 3;
    while (i < 8) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "4. Sukurkite ciklą kuris atspausdintų nuo -3 iki 2. Naudojant <"
  );
  {
    let i = -3;
    while (i < 3) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "5. Sukurkite ciklą kuris atspausdintų nuo 1 iki 5. Naudojant <="
  );
  {
    let i = 1;
    while (i <= 5) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "6. Sukurkite ciklą kuris atspausdintų nuo 3 iki 7. Naudojant <="
  );
  {
    let i = 3;
    while (i <= 7) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "7. Sukurkite ciklą kuris atspausdintų nuo -3 iki 2. Naudojant <="
  );
  {
    let i = -3;
    while (i <= 2) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "8. Sukurkite ciklą kuris atspausdintų nuo 2 iki iki -3. Naudojant >"
  );
  {
    let i = 2;
    while (i > -4) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "9. Sukurkite ciklą kuris atspausdintų nuo -5 iki iki -10. Naudojant >"
  );
  {
    let i = -5;
    while (i > -11) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "10. Sukurkite ciklą kuris atspausdintų nuo 2 iki iki 1. Naudojant >"
  );
  {
    let i = 2;
    while (i > 0) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "11. Sukurkite ciklą kuris atspausdintų nuo 2 iki iki -3. Naudojant >="
  );
  {
    let i = 2;
    while (i >= -3) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "12. Sukurkite ciklą kuris atspausdintų nuo -5 iki iki -10. Naudojant >="
  );
  {
    let i = -5;
    while (i >= -10) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "13. Sukurkite ciklą kuris atspausdintų nuo 2 iki iki 1. Naudojant >="
  );
  {
    let i = 2;
    while (i >= 1) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "14. Sukurkite ciklą kuris atspausdintų 2, 4, 6, 8, 10. Naudojant žingsnį +2"
  );
  {
    let i = 2;
    while (i <= 10) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "16. Sukurkite ciklą kuris atspausdintų 4, 1, -2, -5, -8. Naudojant žingsnį -3"
  );
  {
    let i = 4;
    while (i >= -8) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "18. Sukurkite ciklą kuris atspausdintų 2, 0, -2, -4, -6. Naudojant kintamojo liekaną"
  );
  {
    let i = 2;
    while (i >= -6) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "19. Sukurkite ciklą kuris atspausdintų 2, -1, -4, -7, -10. Naudojant kintamojo liekaną"
  );
  {
    let i = 2;
    while (i >= -10) {
...
console.groupCollapsed("FOR");
{
  ...
  console.groupEnd();
  console.groupCollapsed(
    "18. Sukurkite ciklą kuris atspausdintų 2, 0, -2, -4, -6. Tikrinant ar kintamojo liekana"
  );
  {
    for (i = 2; i >= -6; i += -1) {
      if (i % 2 === 0) {
  ...
  console.groupEnd();
  console.groupCollapsed(
    "19. Sukurkite ciklą kuris atspausdintų 2, -1, -4, -7, -10. Tikrinant ar kintamojo liekana"
  );
  {
    for (i = 2; i >= -10; i += -1) {
      if ((i + 1) % 3 === 0) {
  ...
  {
    for (i = numbers.length - 2; i >= 2; i -= 1) {
      console.log(numbers[i]);
    }
  }
  console.groupEnd();
  ...
  {
    for (i = numbers.length - 1; i >= 0; i -= 2) {
      console.log(numbers[i]);
    }
  }
  console.groupEnd();
  ...
  {
    for (i = numbers.length - 1; i >= 0; i -= 3) {
      console.log(numbers[i]);
    }
  }
  console.groupEnd();
